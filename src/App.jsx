...
import { 
  ...
  Mail, Linkedin, Printer, Menu, X, ChevronRight, Activity, 
  CheckCircle, Globe, Phone, BookOpen, FileCheck,
  Languages, Cpu, Quote, Youtube, Music, Send, Archive
} from 'lucide-react';
...
const educationData = [
  {
    ...
    documents: [
      { name: "Red Diploma", type: "Certificate" },
      { name: "Transcript (GPA 5.0)", type: "Transcript" },
      { name: "Certificate of Honor", type: "Certificate" },
      { name: "My Master Thesis", type: "Certificate" },
      { name: "Independent Thesis Evaluation Certificates", type: "Certificate" }
    ]
  },
  {
    ...
    documents: [
      { name: "M.D. Diploma", type: "Diploma" },
      { name: "MCC Report: Canadian Equivalency Established", type: "Report" },
      { name: "Clinical Rotation Certificates", type: "Certificate" }
    ]
  },
  {
    ...
    documents: [
      { name: "Baccalaureate Diploma", type: "Diploma" }
    ]
  }
];
...
const researchExperience = [
  {
    ...
    documents: [{ name: "Internship Certificate", type: "Certificate" }]
  },
  {
  ...
  },
  {
    ...
    documents: [{ name: "Research Certificate", type: "Certificate" }]
  },
  {
    title: "Research Assistant",
...
const clinicalExperience = [
  {
    ...
    documents: [
    { name: "RIG Pass Training Certificate", type: "Certificate" },
    { name: "Recommendation Letters", type: "Document" },
    { name: "Compliments/Performance Emails", type: "Document" }
    ]
  },
  {
    ...
    documents: [{ name: "Work Certificate", type: "Certificate" }]
  },
  {
    title: "General Practitioner",
  ...
  },
  {
    ...
    documents: [{ name: "Medical Internship Certificates", type: "Certificate" }]
  }
];
...
const voluntaryService = [
  ...
  },
  {
    ...
    documents: [{ name: "Certificate", type: "Certificate" }]
  },
  {
    title: "Member",
    ...
    documents: [{ name: "Membership Card", type: "Certificate" }]
  }
];
...
const certifications = [
  { id: 1, title: "Advanced Cardiac Life Support (ACLS)", issuer: "NHCPS/AHA", category: "Clinical", date: "2022" },
  { id: 2, title: "COVID-19 Training for Healthcare Workers", issuer: "Stanford University", category: "Clinical", date: "2021" },
  { id: 3, title: "RIG Pass Training", issuer: "British Safety Services", category: "Safety", date: "2023" },
  { id: 4, title: "Single-Cell RNA Library Preparation", issuer: "RUDN University/ASCA", category: "Research", date: "2024" },
  { id: 7, title: "Advanced Training in Engineering Physiology", issuer: "Sechenov University", category: "Diploma", date: "2024", highlight: true },
  { id: 8, title: "Training in Phytotherapy", issuer: "BIOS & Laboratorios Herssen", category: "Research", date: "2019" },
  { id: 9, title: "IELTS Academic Certificate", issuer: "British Council", category: "Language", date: "2022", score: "7.5/9" },
  { id: 10, title: "TEFL Certificate", issuer: "TEFL Professional Development", category: "Language", date: "2020" },
  { id: 11, title: "Multiple CME Certificates", issuer: "WebMD, Medscape, National Lipid Association", category: "CME", date: "2020-2022", count: "50+" },
  { id: 12, title: "Skoltech Scholarship for Summer Internship", issuer: "Skoltech University", category: "Internship", date: "2024" },
  { id: 13, title: "ROSBIOTECH Spring Internship Winner", issuer: "Russian Biotechnological University", category: "Internship", date: "2024" },
  { id: 14, title: "Research Assistant", issuer: "Institute of Immunology, FMBA of Russia", category: "Internship", date: "2024-Present" }
];
  ...
  <Card className="mb-6 border-l-4 border-l-blue-600">
    ...
    {documents && (
      <div className="mt-4 pt-3 border-t border-slate-100">
        <h4 className="font-semibold text-slate-800 text-xs uppercase mb-2 flex items-center gap-1">
          <FileCheck size={12} className="text-blue-600"/> Supporting Documentation
        </h4>
...
export default function Portfolio() {
  ...
  const navItems = [
    ...
    { id: 'voluntary', label: 'Voluntary Service', icon: CheckCircle }, 
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 text-slate-800 font-sans print:bg-white">
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <aside className={`fixed lg:sticky top-0 h-screen w-72 bg-gradient-to-b from-slate-900 to-slate-800 text-slate-300 p-6 z-40 transition-transform duration-300 transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 overflow-y-auto border-r border-slate-700 flex flex-col shadow-2xl print:hidden`}>
          <div className="mb-8 pt-12 lg:pt-0 text-center lg:text-left">
            <div className="w-32 h-32 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-full mb-4 mx-auto lg:mx-0 flex items-center justify-center overflow-hidden shadow-xl ring-4 ring-blue-500/30 relative">
              ...
              />
              <div className="w-full h-full bg-slate-700 hidden items-center justify-center text-3xl font-bold text-white absolute inset-0">
                HB
              </div>
            </div>
        ...
        <main className="flex-1 p-4 lg:p-12 lg:ml-0 mt-14 lg:mt-0 max-w-6xl print:p-0 print:m-0">
            ...
            {educationData.map((edu, index) => (
              <Card key={index} className={index === 0 ? "border-l-4 border-l-red-500 relative overflow-hidden" : "border-l-4 border-l-blue-500"}>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  {/* PhD Style Dossier Request */}
                  {edu.documents && (
                    <div className="bg-slate-50 p-5 rounded-lg border border-slate-200 h-fit">
                      <h4 className="font-bold text-xs text-slate-800 uppercase mb-4 flex items-center gap-2 border-b border-slate-200 pb-2">
                        <FileCheck size={14} className="text-slate-500" /> 
                        Academic Record & Proofs
                      </h4>
                      ...
                      <a 
                        href={`mailto:${contactInfo.email}?subject=Request for Academic Documents: ${edu.degree}&body=Dear Dr. Bensaada,%0D%0A%0D%0AI am reviewing your portfolio and would like to request access to the verifying documents for your ${edu.degree}.`}
                        className="w-full flex items-center justify-center gap-2 bg-white border border-slate-300 hover:border-blue-400 hover:text-blue-600 text-slate-600 py-2 rounded-md text-sm font-medium transition-all shadow-sm"
                      >
                        <Mail size={14} /> Request Full Dossier
                      </a>
                    </div>
                  )}
                </div>
          ...
          <SectionTitle id="voluntary" icon={CheckCircle} title="Voluntary Service" />
          <div className="space-y-8 mb-20">
          ...
          <div className="mb-20">
            {/* Global Notice for Certifications */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
               ...
               {(activeTab === 'All' || activeTab === 'Research' || activeTab === 'Diploma') && (
                  <div className="bg-gradient-to-br from-indigo-50 to-white border border-indigo-200 rounded-xl p-4 shadow-sm">
                      ...
                      <a 
                        href={`mailto:${contactInfo.email}?subject=Request for Diploma: Engineering Physiology`}
                        className="mt-3 pt-3 border-t border-indigo-100 flex items-center justify-between text-slate-400 hover:text-indigo-600 cursor-pointer"
                      >
                        <span className="text-xs font-medium flex items-center gap-1"><Mail size={12}/> Request Copy</span>
                      </a>
                  </div>
               )}
          ...
          <footer className="mt-20 pt-8 border-t border-slate-200 text-center text-slate-500 text-sm">
            ...
            <p className="text-xs">Designed for Academic & Professional Applications</p>
          </footer>
        </main>
      </div>
    </div>
